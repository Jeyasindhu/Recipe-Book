...
function get4thRecipe() {
  document.querySelector(".fourth-meal-detail").style.display = "block";
}
function get5thRecipe() {
  document.querySelector(".fifth-meal-detail").style.display = "block";
}
function get6thRecipe() {
  document.querySelector(".sixth-meal-detail").style.display = "block";
}
function get7thRecipe() {
  document.querySelector(".seventh-meal-detail").style.display = "block";
}
function get8thRecipe() {
  document.querySelector(".eighth-meal-detail").style.display = "block";
}
...
function closeBtn() {
  ...
  document.querySelector(".fourth-meal-detail").style.display = "none";
  document.querySelector(".fifth-meal-detail").style.display = "none";
  document.querySelector(".sixth-meal-detail").style.display = "none";
  document.querySelector(".seventh-meal-detail").style.display = "none";
  document.querySelector(".eighth-meal-detail").style.display = "none";
